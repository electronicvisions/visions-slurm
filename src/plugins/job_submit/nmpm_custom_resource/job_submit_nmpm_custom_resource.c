...
#define MAX_ADC_ENV_LENGTH_PER_WAFER                                                               \
	(MAX_ADC_COORD_LENGTH * MAX_ADCS_PER_WAFER + MAX_ENV_NAME_LENGTH)
#define MAX_LICENSE_STRING_LENGTH_PER_WAFER                                                        \
	(MAX_ADC_COORD_LENGTH * MAX_ADCS_PER_WAFER + NUM_HICANNS_ON_WAFER * 6)
#define NMPM_PLUGIN_SUCCESS 0
#define NMPM_PLUGIN_FAILURE -1
#define ALLOCATED_HICANN_ENV_NAME "ALLOCATED_HICANNGLOBAL="
#define ALLOCATED_ADC_ENV_NAME "ALLOCATED_ADC="
...
static const struct option_index_t custom_res_options[NUM_OPTIONS] = {
	...
	{ "fpga_with_aout",                 2},
	{ "hicann_with_aout",               3},
	{ "reticle_of_hicann_with_aout",    4},
	{ "reticle",                        1},
	{ "fpga",                           2},
	{ "hicann",                         3},
	{ "reticle_of_hicann",              4},
	{ "reticle_without_aout",           5},
	{ "fpga_without_aout",              6},
	{ "hicann_without_aout",            7},
	{ "reticle_of_hicann_without_aout", 8},
	{ "hwdb_path",                      9},
	{ "skip_master_alloc",             10},
};
